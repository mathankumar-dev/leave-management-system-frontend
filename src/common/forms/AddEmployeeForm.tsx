...
import type { CreateUserRequest } from "../../features/dashboard/types";
...
const FormInput = ({ label, required, ...props }: any) => (
  <div>
    ...
    <input {...props} className="w-full border px-3 py-2 rounded mt-1 focus:ring-2 focus:ring-indigo-500 outline-none transition-all" />
  </div>
);
