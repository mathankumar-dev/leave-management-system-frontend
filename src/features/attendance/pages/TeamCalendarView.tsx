                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 overflow-hidden space-y-0.5 hidden sm:block">
                          {holiday && <div className="px-1 py-0.5 bg-rose-100/50 border border-rose-200 text-rose-600 text-[7px] font-black uppercase rounded-sm truncate">{holiday}</div>}
                          {mine.length > 0 && <div className="px-1 py-0.5 bg-amber-100 border border-amber-200 text-amber-700 text-[7px] font-black uppercase rounded-sm truncate">ME: LEAVE</div>}
