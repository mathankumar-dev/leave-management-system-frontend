            ...
            <div className="p-6 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-100">
                  ...
                  <p className="text-2xl font-black text-indigo-700">{stat?.total}</p>
                </div>
                <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-100">
                  <p className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest">Used to Date</p>
                  <p className="text-2xl font-black text-emerald-700">{stat?.used}</p>
                </div>
              </div>
              ...
              <div className="p-4 bg-amber-50 rounded-lg border border-amber-100 flex gap-3">
                ...
                <p className="text-xs text-amber-800 leading-relaxed">
                  <strong>Policy Note:</strong> {stat?.title} requires 24-hour advance notice for non-emergencies. Max 3 consecutive days allowed without documentation.
                </p>
              </div>
