        ...
        {stats.map((stat, i) => (
          <div key={i} className="bg-white border border-slate-200 rounded-md p-4 shadow-sm">
            ...
            <div className="flex justify-between items-end mt-2">
              <h3 className="text-2xl font-bold text-slate-800">{stat.total - stat.used}</h3>
              <p className="text-[10px] font-medium text-slate-500">Available / {stat.total}</p>
            </div>
