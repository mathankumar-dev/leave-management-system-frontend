...
const CalendarView: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-hidden  flex flex-col gap-4 min-w-0 -mt-2.5">
        ...
        <div className="bg-white overflow-hidden border border-slate-200 rounded-xl shadow-sm overflow-hidden relative">
          {loading && (
