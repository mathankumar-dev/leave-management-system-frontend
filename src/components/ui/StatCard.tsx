...
const StatCard: React.FC<StatCardProps> = ({
  ...
  const ringColor =
    color || (title.toLowerCase().includes("sick") ? "#2563eb" : "#6366f1");
  ...
  return (
    <div
      ...
      className={`
        ...
        shadow-sm p-7 flex flex-col justify-between h-full
        transition-all duration-300 group border-b-4
      ...
      <div className="flex justify-between items-center gap-4">
        ...
        <div className="space-y-1">
          ...
          <h3 className="text-4xl font-black text-slate-900 tracking-tight">
            {used}
            <span className="text-lg text-slate-300 ml-1">Days</span>
          </h3>
